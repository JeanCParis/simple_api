## start locally
node src/index.js --service sample-node-api --port 3000 --key sslcert/server.key --cert sslcert/server.cert -v
...
node src/index.js --service sample-node-api --port 3000 --key ${KEYSTORE_KEY} --cert ${KEYSTORE_CERTIFICATE} -v
